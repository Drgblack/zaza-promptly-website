...
Zaza Coach is designed for:

- Private tutors (e.g., languages, test prep, mathematics, music)
- Freelance educators and solopreneurs
...
### 🔹 AI Tutor Twin™
An AI-powered clone trained on your unique teaching style. The Twin helps students between sessions, generates exercises, follows up with parents, and can even create content that mirrors your tone and pedagogy.

### 🔹 RevenuePilot™
Your income-boosting co-pilot. This module gives you smart pricing suggestions, identifies client churn risks, and recommends schedule optimisations that directly grow your earnings.
...
Capture session transcripts automatically. Action points and feedback are extracted and summarised for students, parents, or tutors.
...
- **Zaza Site** (€9/mo): A beautifully branded personal website with booking integration.
- **Zaza Pay** (€15/mo): Pro-level billing, receipts, and tax dashboards.
- **Zaza ClassLink** (€12/mo): Secure shared portal for students and families.
- **Zaza Groups** (€19/mo): Run group lessons, assign peer-based activities, and more.
...
| Enterprise   | Custom    | White-labelling, team dashboards, API access                                    |
...
- Unified Zaza ID login system
- Human-in-the-loop AI for transparency and trust
- Modular roadmap with wearable integration, API expansion, and marketplace tools

---

## 📊 Impact Metrics We Track

- Hours saved per tutor/month
- % revenue growth post-adoption
- Engagement streaks + student retention
- Referrals and shared session content
