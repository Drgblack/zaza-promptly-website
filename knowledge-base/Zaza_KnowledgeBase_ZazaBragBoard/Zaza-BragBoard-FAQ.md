...
**Q: Is this just ChatGPT with a different name?**  
A: Absolutely not. While we use OpenAI’s GPT-4 as a base, BragBoard has been deeply constrained, fine-tuned, and aligned for use in real classrooms. That means:
- No hallucinations
- No inappropriate suggestions
- Aligned with real teacher tone and learning values
- Designed to mirror how teachers actually praise students

**Q: Can I use this even if I don’t work in a classroom?**  
A: Yes. Many parents, tutors, after-school program leaders, and homeschoolers use BragBoard to recognise children’s effort, kindness, creativity, and learning growth.
...
- Bulk user seats with tiered pricing
- Admin dashboards
- Staff onboarding support
- Live PD (professional development)
- Team celebration sharing libraries

**Q: Can we pay by invoice or purchase order (PO)?**  
A: Absolutely. We support invoices and bank transfers for verified institutions. Just contact: [support@zazatechnologies.com](mailto:support@zazatechnologies.com).

---

## 🧰 Features & Functionality

**Q: What can I actually *make* with BragBoard?**  
A: Teachers use it to generate:
- Weekly student shoutouts
- End-of-term certificates
- Parent newsletter praise blurbs
- SEL-aligned recognition slips
- Brag wall quotes
- Morning meeting celebrations
- Custom appreciation messages for peers or students

**Q: Can I change what the AI writes?**  
A: Of course. All messages are editable. You’re in full control. Think of BragBoard as your time-saving writing buddy, not a black box.

**Q: Can I save and reuse my favourite messages?**  
...
**Q: Can we sign a privacy agreement for our school/district?**  
A: Absolutely. Email [support@zazatechnologies.com](mailto:support@zazatechnologies.com) and our team will walk you through our DPA process.

---

## 👩‍🏫 For Schools & Teams

**Q: How do schools typically use BragBoard?**  
A: Examples include:
- Weekly assemblies with teacher-generated praise slides
- Celebrations printed and posted on school brag walls
- Emailing recognitions to parents as positive contact
- SEL-linked praise frameworks shared across grades
- Cross-campus shoutout swaps between teachers

**Q: Can BragBoard support house points, badges, or rewards?**  
A: Not directly yet, but teachers often export praise notes into reward systems, print them as certificates, or share them in class chats. Gamification support is on our roadmap.

**Q: Can we get a demo or staff training session?**  
A: Yes. Live demos and professional learning sessions are included with the School Licence and available on request for Pro users.
...
A: Our team responds to all emails within 24 hours. Pro users receive prioritised help. School Licence users have a dedicated onboarding manager and faster support channels.

**Q: Is there a community or resource hub?**  
A: Yes! We’re launching the **Zaza Educator Hub**, where teachers share templates, celebration strategies, and ideas for boosting classroom joy.

**Q: Can I suggest features?**  
A: Please do! Zaza BragBoard is teacher-built and teacher-powered. Use the built-in “Feedback” button or email us anytime.
...
Need more help?  
Reach us any time at: [support@zazatechnologies.com](mailto:support@zazatechnologies.com)  
or visit [https://zazatechnologies.com/bragboard](https://zazatechnologies.com/bragboard)
