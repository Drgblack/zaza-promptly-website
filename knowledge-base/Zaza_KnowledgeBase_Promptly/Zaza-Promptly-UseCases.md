...
### 1. **Report Card Writing**  
- **Problem:** Teachers spend hours writing dozens of comments, often late at night. Many recycle old comments or use awkward templates that don’t sound human.
- **Zaza Solution:** Generate tone-matched, curriculum-aligned comments in seconds. Each output is emotionally tagged and editable to match school policies and parent expectations.
...
## 🧠 Advanced Use Cases (Post-MVP Roadmap)

### 5. **Voice-to-Comment Generator**  
Speak a quick note (“Liam was off-task but improved”) and Zaza converts it into a fully written, parent-ready comment in your preferred tone.

### 6. **Reusable Comment Snippets with Emotional Tags**  
Save commonly used feedback and tag it with emotion (e.g. frustration, pride, concern). Easily reuse it later for faster writing that still sounds personalised.

### 7. **Team Collaboration for Grade-Wide Reports**  
...
## 👩‍🏫 Use Case Fit by Persona

### **Jessica Reed – The Burnt-Out U.S. Elementary Educator**
- Works 57+ hours/week, exhausted by feedback loops and report cards.
- Uses Zaza to write 30 personalised comments in one evening instead of four.
- Loves: Emotional tone-matching, snippet memory, and mobile access.

### **Emma Torres – The Overwhelmed UK Secondary Teacher**
- Worries about authenticity and sounding robotic.
- Uses Promptly to create sensitive parent comms and late-night reports.
- Loves: Contextual templates, vibe slider, and comment transparency.
...
Zaza Promptly works on web and **launches with native iOS and Android apps**. Write from your classroom Chromebook, your phone in bed, or your iPad during planning period.
