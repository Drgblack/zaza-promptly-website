...
export function ResourcesClient({ locale }: ResourcesClientProps) {
  const { trackEvent } = useAnalytics();
  const t = useTranslations();
  
  // Resource data - will be internationalized later
  ...
  const handleDownloadAll = () => {
    ...
    trackEvent('resource_download', { type: 'bulk_download', resource: 'all_resources', locale });
    trackEvent('button_click', { button: 'Download All Resources', page: 'resources_page', locale });
  ...
  const handleDownload = (url: string, fileName: string) => {
    ...
    trackEvent('resource_download', { 
      ...
      resource: fileName.replace('.docx', ''), 
      locale 
    });
  ...
  const handleTryDemo = () => {
    ...
    if (demoSection) {
      ...
      window.location.href = `/${locale}#demo-section`;
    }
  };
      ...
      <section className="py-8">
        <div className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
          <BrevoForm
            ...
            tags={['resource_visitor', 'top_signup', `locale_${locale}`]}
          />
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
          <BrevoForm
            ...
            tags={['resource_visitor', 'bottom_signup', `locale_${locale}`]}
          />
        </div>
      </section>
