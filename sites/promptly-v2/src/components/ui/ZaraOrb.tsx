...
export default function ZaraOrb({ isInSnippetTool = false, onContextAction }: ZaraOrbProps) {
  ...
  // Context-aware buttons based on Snippet Tool usage
  ...
  const handleContextAction = (action: string) => {
    ...
    // Also send to chat
    sendMessage(`Please ${action.toLowerCase()} based on the current snippet.`)
  }
  ...
  const sendMessage = async (message: string) => {
    ...
    try {
      ...
      const responses = [
        "I'd be happy to help with that! For educational content, I recommend keeping language clear and student-appropriate.",
        "⚠️ Remember to keep conversations general and avoid sharing specific student information.",
        "Great question! Here's a teacher-friendly suggestion for your content...",
        "For parent communication, consider a warm but professional tone like this:",
      ]
