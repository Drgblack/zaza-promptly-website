...
export default function SnippetToolV2({ locale = 'en' }: SnippetToolV2Props) {
  ...
  // Feature flag for new version - default OFF in production
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  readOnly
                  rows={12}
                  className={`w-full px-3 py-2 border rounded-lg text-white placeholder-slate-400 focus:outline-none resize-none ${
                    error
            ...
            {generatedText && !error && (
              <button
                onClick={handleCopy}
                className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-slate-700 hover:bg-slate-600 text-slate-300 hover:text-white font-medium rounded-lg transition-colors"
              >
                {copySuccess ? (
                  <>
