...
export default function PromptlyHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-slate-200 dark:bg-slate-900/95 dark:border-slate-700">
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" aria-label="Global">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex lg:flex-1">
            <Link
              href="/"
              className="-m-1.5 p-1.5 flex items-center gap-3 hover:opacity-80 transition-opacity duration-300"
            >
              ...
              <span className="text-xl font-bold text-slate-900 dark:text-white">Zaza Promptly</span>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex lg:gap-x-2">
            {navigation.map((section) => (
              ...
              >
                <button
                  className={cn(
                    "flex items-center gap-1 text-sm font-medium leading-6 px-3 py-2 rounded-md transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2",
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-4 lg:items-center">
            <button
              ...
              className="p-2 rounded-md text-slate-700 hover:text-slate-900 hover:bg-slate-100 dark:text-slate-300 dark:hover:text-white dark:hover:bg-slate-800 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2"
            ...
            <Button
              asChild
              className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold px-4 py-2 text-sm rounded-md transition-colors duration-300"
            >
            ...
            <Button
              ...
              className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold px-4 py-2 text-sm rounded-md transition-colors duration-300"
            >
              <Link href="/signup">Try Zaza Promptly</Link>
            </Button>
          </div>
        </div>
      </nav>
      ...
      <div className={cn("lg:hidden", mobileMenuOpen ? "fixed inset-0 z-50" : "hidden")}>
        <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white dark:bg-slate-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-slate-900/10 dark:sm:ring-slate-100/10">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-slate-500/10 dark:divide-slate-400/10">
                ...
                {navigation.map((section) => (
                  <div key={section.name}>
                    <button
                      ...
                      className="flex w-full items-center justify-between rounded-lg px-3 py-2 text-base font-medium leading-7 text-slate-900 hover:bg-slate-50 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 dark:text-white dark:hover:bg-slate-800"
              ...
              <div className="py-6 space-y-4">
                <button
                  onClick={toggleDarkMode}
                  className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-base font-medium leading-7 text-slate-900 hover:bg-slate-50 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 dark:text-white dark:hover:bg-slate-800"
                  aria-label={isDarkMode ? "Switch to light mode" : "Switch to dark mode"}
                >
                  {isDarkMode ? <Sun className="h-5 w-5" /> : <Moon className="h-5 w-5" />}
                ...
                >
                  <Link href="/zaza-teach-website" onClick={() => setMobileMenuOpen(false)}>
                    Try Zaza Teach
                  </Link>
                </Button>
                <Button
