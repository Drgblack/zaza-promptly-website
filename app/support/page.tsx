...
export const metadata: Metadata = {
  title: 'Support Center | Get Help with AI Teaching Tools - Zaza Technologies',
  description: 'Get comprehensive support for Zaza Promptly and all Zaza Technologies products. Find help guides, contact support, and access resources.',
  keywords: 'Zaza support, AI teaching tools help, Zaza Promptly support, educational technology assistance, teacher support center',
  openGraph: {
    title: 'Support Center - Zaza Technologies',
    description: 'Get the help you need with our AI-powered teaching tools. Comprehensive support and resources for educators.',
    type: 'website',
  ...
  alternates: {
    canonical: 'https://zazapromptly.com/support',
  },
};
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border border-gray-200 p-6 rounded-lg">
                ...
                <Link href="/promptly-faq" className="text-purple-600 hover:underline">View FAQ →</Link>
              </div>
