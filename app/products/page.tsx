...
export const metadata: Metadata = {
  title: 'Zaza Products - AI tools for teachers',
  description: 'Explore all Zaza tools - teacher-first AI that lightens the load so you can focus on students.',
  keywords: 'AI tools for teachers, Zaza Promptly, Zaza Teach, educational technology, teacher productivity',
  openGraph: {
    title: 'Zaza Products - AI tools for teachers',
    description: 'Explore all Zaza tools - teacher-first AI that lightens the load so you can focus on students.',
    type: 'website',
...
const teachingTools = [
  {
    ...
    imageAlt: 'Zaza Promptly - teacher writing warm parent messages with AI help'
  },
  {
    id: 'teach',
    name: 'Zaza Teach',
    description: 'Your AI lesson planning assistant. Build engaging, curriculum-aligned lessons faster - with less stress.',
    primaryCTA: 'Learn more',
    primaryLink: '/teach',
    icon: BookOpen,
    color: 'from-blue-500 to-indigo-500',
    bgColor: 'bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20',
    imageAlt: 'Zaza Teach - AI-supported lesson plan on a laptop'
  },
  {
    id: 'autoplanner',
    name: 'Zaza AutoPlanner',
    description: 'Our flagship intelligent agent for multimodal lesson planning. Adaptive, classroom-aware, and built for the future of teaching.',
    primaryCTA: 'Learn more',
    ...
    imageAlt: 'Zaza AutoPlanner - intelligent agent orchestrating lesson components'
  }
];
...
const otherZazaApps = [
  {
    ...
    description: 'AI communication tools for work - helpful for educators writing policies, proposals, or reports.',
    primaryCTA: 'Learn more',
    primaryLink: '/notably',
    ...
    imageAlt: 'Zaza Notably - professional communication with AI assistance'
  },
  {
    id: 'spark',
    name: 'Zaza Spark (HR)',
    description: 'AI productivity for HR teams. Useful for schools: onboarding, training, and staff communication made simpler.',
    primaryCTA: 'Learn more',
    primaryLink: '/spark',
    secondaryCTA: 'Join waitlist',
    secondaryLink: '/waitlist',
    ...
    imageAlt: 'Zaza Spark - HR onboarding and training flows with AI'
  },
  {
    id: 'looop',
    name: 'Zaza Looop',
    description: 'Culturally immersive AI language learning. For bilingual classrooms or teachers growing their own language skills.',
    primaryCTA: 'Learn more',
    primaryLink: '/looop',
    secondaryCTA: 'Join waitlist',
    secondaryLink: '/waitlist',
    ...
    imageAlt: 'Zaza Looop - language learning with cultural context'
  },
  {
    id: 'knowledgecore',
    name: 'Zaza KnowledgeCore',
    description: 'The memory spine for teaching. Capture, organise, and resurface your best ideas and resources across your career.',
    primaryCTA: 'Learn more',
    ...
    imageAlt: 'Zaza KnowledgeCore - organised knowledge vault for teachers'
  }
];
...
function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card className="group relative overflow-hidden border-0 bg-white dark:bg-gray-900 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-purple-500">
      ...
      <section className="relative py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <EmailCaptureForm
            ...
            subtitle="Get early access and product updates"
