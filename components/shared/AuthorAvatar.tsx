...
const isFounder = (name: string): boolean => {
...
export function AuthorAvatar({
  ...
  const displayName = isFounderName ? 'Dr Greg Blackburn' : name;
  const displayRole = isFounderName ? 'PhD in Professional Education' : role;
