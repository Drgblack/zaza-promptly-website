            ...
            <div className="relative">
              ...
              {isDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2">
                  <Link href="/promptly" className="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                    Promptly
                  </Link>
                  <Link href="/teach" className="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                    Teach
                  </Link>
                  <Link href="/technologies" className="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                    Technologies
                  </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex flex-col space-y-4">
              <Link href="/promptly" className="text-gray-700 dark:text-gray-300">
                Promptly
              </Link>
              <Link href="/teach" className="text-gray-700 dark:text-gray-300">
                Teach
              </Link>
              <Link href="/technologies" className="text-gray-700 dark:text-gray-300">
                Technologies
              </Link>
              <Link href="/learning-centre" className="text-gray-700 dark:text-gray-300">
                Learning Centre
              </Link>
              <Link href="/about-us" className="text-gray-700 dark:text-gray-300">
                About Us
              </Link>
              
              <div className="pt-4 border-t border-gray-200 dark:border-gray-700 flex flex-col space-y-2">
                <Link href="/teach" className="text-blue-600 dark:text-blue-400 font-medium">
                  Try Zaza Teach
                </Link>
                <Link href="/waitlist" className="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium text-center">
                  Join Waitlist
                </Link>
              </div>
            </div>
