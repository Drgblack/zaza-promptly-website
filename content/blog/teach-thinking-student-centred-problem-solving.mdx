...
seo:
  ...
  keywords: ["critical thinking teaching", "problem-solving framework", "student-centred learning", "lesson planning", "teaching strategies"]
...
But when you ask, "Why might removing foxes from this habitat affect the entire system?" — silence.
...
**Low-prep activity**: Problem gallery walk — display the challenge on paper around the room, students move and annotate with sticky notes.
...
**Teacher micro-script**: "Now we brainstorm. All ideas welcome — we'll evaluate later. What might work here? What patterns do you recognise from similar problems?"

**Student action**: Individual brain dump (2 minutes), then share in groups of four, building on each other's ideas.

**Low-prep activity**: Hypothesis carousel — groups rotate around stations, adding solutions to different aspects of the problem.
...
**Low-prep activity**: Evidence sorting — provide mixed information cards, students categorise by relevance to different hypotheses.
...
**Teacher micro-script**: "Different groups may have reached different conclusions. That's good — it means you're thinking critically. Present your strongest argument and listen to others. What makes one explanation more convincing?"

**Student action**: Gallery walk of group findings, followed by structured debate using claim-evidence-reasoning format.

**Low-prep activity**: Standing debate — students physically move to show agreement/disagreement, must justify their position before moving.
...
**Low-prep activity**: Thinking strategy auction — students 'bid' on the most useful problem-solving approaches with play money.
...
1. **"Walk me through your thinking"** — Gets students to verbalise their process
...
6. **"What would happen if...?"** — Assesses transfer and application
...
*Ready to transform how your students think about learning? Start with the THINK framework tomorrow and watch their confidence grow as they tackle problems with purpose and strategy.*