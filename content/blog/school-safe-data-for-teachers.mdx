...
seo:
  ...
  keywords: ["school data privacy", "AI in education", "GDPR compliance", "data security", "teacher guide"]
...
*Ready to use AI safely with school data? Start with one Green-Amber-Red sort tomorrow. Teach the lesson once. Then keep the habit small and steady. Trust grows when everyone can see the boundaries and the benefits.*